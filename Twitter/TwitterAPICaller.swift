...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "en9fiBUz7rB4m8Y4FBZ4uwge2", consumerSecret: "3IAsIFX5L64I8sBDpCRKsljaViiXRzxwywgGiUEqs5l3Y1Qw3P")
    var loginSuccess: (() -> ())?
